  ...
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      if (
        ...
        return res
          .status(400)
          .json({ message: "Campos obrigatório não preenchido." });
      }
...
app.patch("/api/products/:id", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const { id, productCode, productName, productDescription, productPrice } =
        req.body;
      ...
      res
        .status(200)
        .json({ message: "O produto foi atualizado com sucesso!" });
    } catch (err) {
